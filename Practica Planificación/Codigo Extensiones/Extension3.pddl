(define (domain desplazamientos-ext3)
    ...
    (:functions
        ...
        (prioridad ?rec - recurso ?baseDestino - base)      ;;Marca la prioridad (que puede ser 1, 2 o 3) de cada peticion
        (sumaPrioridad)         ;;Cuenta la suma de prioridades de las peticiones que ya se han completado
    ...
    (:action dejarSuministro
        ...
        :effect (and 
                    ...
                    (posicionRecurso ?sum ?pos)
                    (entregado ?sum)
                    (increase (sumaPrioridad) (prioridad ?sum ?pos)))
    )
    ...
    (:action dejarPersona
        ...
        :effect (and 
                    ...
                    (posicionRecurso ?per ?pos)
                    (entregado ?per)
                    (increase (sumaPrioridad) (prioridad ?per ?pos)))
    )
)